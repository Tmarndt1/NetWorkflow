...
namespace NetWorkflow
{
    ...
    public interface IWorkflow<TOut>
    {
        ...
        IWorkflowBuilder<TOut> Build(IWorkflowBuilder builder);
        ...
        IWorkflowResult<TOut> Run(CancellationToken token = default);
        ...
        Task<IWorkflowResult<TOut>> RunAsync(CancellationToken token = default);
    }
}
