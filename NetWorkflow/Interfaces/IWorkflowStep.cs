...
namespace NetWorkflow
{
    ...
    /// <summary>
    /// Interface that defines a WorkflowStep that requires an input of type TIn and defines an output of type TOut.
    /// </summary>
    ...
    /// <summary>
    /// Interface that defines an async WorkflowStep that requires no input and defines an output of type TOut.
    /// </summary>
    /// <typeparam name="TOut">The type of the WorkflowStep's output.</typeparam>
    ...
    /// <summary>
    /// Interface that defines an async WorkflowStep that requires an input of type TIn and defines an output of type TOut.
    /// </summary>
    /// <typeparam name="TIn">The type of the previous output.</typeparam>
    /// <typeparam name="TOut">The type of the WorkflowStep's output.</typeparam>
